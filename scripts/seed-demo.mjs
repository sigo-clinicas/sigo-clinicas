// =============================================================================
// SEED DE DEMONSTRAÇÃO — enriquece a "[TESTE] Clínica Demo" que JÁ EXISTE.
//
...
async function main() {
  ...
  // ── 2) Profissionais ──────────────────────────────────────────────────────
  const PROFS = [
    { k: "marina", nome: "[TESTE] Dra. Marina Alves", cor: "#6366f1",
      conselho: "CRBM", reg: "12345-SP", ini: "09:00", fim: "18:00" },
    { k: "rafael", nome: "[TESTE] Dr. Rafael Costa", cor: "#10b981",
      conselho: "CRM", reg: "98765-SP", ini: "08:00", fim: "17:00" },
    { k: "juliana", nome: "[TESTE] Dra. Juliana Prado", cor: "#f59e0b",
  ...
  // ── 3) Serviços + preços ──────────────────────────────────────────────────
  const SERVS = [
    { k: "limpeza", nome: "[TESTE] Limpeza de Pele", dur: 60, valor: 150 },
    { k: "peeling", nome: "[TESTE] Peeling Químico", dur: 45, valor: 220 },
    { k: "massagem", nome: "[TESTE] Massagem Modeladora", dur: 50, valor: 180 },
    { k: "botox", nome: "[TESTE] Toxina Botulínica (Botox)", dur: 40, valor: 890 },
    { k: "preenchimento", nome: "[TESTE] Preenchimento Labial", dur: 45, valor: 1200 },
    { k: "drenagem", nome: "[TESTE] Drenagem Linfática", dur: 60, valor: 130 },
    { k: "microagulhamento", nome: "[TESTE] Microagulhamento", dur: 50, valor: 450 },
  ];
  const S = {};
  for (const s of SERVS) {
    S[s.k] = await porChaveNatural(
      ...
      { clinica_id: CLINICA_ID, nome: s.nome },
      {
        ...
        descricao: `Procedimento de demonstração — ${s.nome.replace("[TESTE] ", "")}.`,
      },
      `serviço ${s.nome}`
    );
  }
  ...
  const TAB_PART = await porChaveNatural(
    "tabela_preco",
    { clinica_id: CLINICA_ID, nome: "[TESTE] Particular" },
    { convenio_id: null, exibir_publico: true, ativo: true },
    "tabela [TESTE] Particular"
  );
  for (const s of SERVS) {
  ...
  const CONVS = [
    { k: "unimed", nome: "[TESTE] Unimed Demo", cod: "UNI-001", prazo: 30, fator: 0.7 },
    { k: "bradesco", nome: "[TESTE] Bradesco Saúde Demo", cod: "BRA-002", prazo: 45, fator: 0.65 },
    { k: "sulamerica", nome: "[TESTE] SulAmérica Demo", cod: "SUL-003", prazo: 60, fator: 0.6 },
  ];
  const CV = {};
  for (const c of CONVS) {
    ...
    const tab = await porChaveNatural(
      "tabela_preco",
      { clinica_id: CLINICA_ID, nome: `[TESTE] Tabela ${c.nome.replace("[TESTE] ", "")}` },
  ...
  // ── 5) Pacientes (12) ─────────────────────────────────────────────────────
  const PACS = [
    { k: "ana", nome: "[TESTE] Ana Souza", cpf: "10000000001", nasc: "1990-04-12", sexo: "feminino", conv: "unimed" },
    { k: "bruno", nome: "[TESTE] Bruno Lima", cpf: "10000000002", nasc: "1985-11-03", sexo: "masculino", conv: null },
    { k: "carla", nome: "[TESTE] Carla Dias", cpf: "10000000003", nasc: "1998-07-22", sexo: "feminino", conv: "bradesco" },
    { k: "daniela", nome: "[TESTE] Daniela Rocha", cpf: "10000000004", nasc: "1992-02-18", sexo: "feminino", conv: null },
    { k: "eduardo", nome: "[TESTE] Eduardo Martins", cpf: "10000000005", nasc: "1979-09-30", sexo: "masculino", conv: "unimed" },
    { k: "fernanda", nome: "[TESTE] Fernanda Vieira", cpf: "10000000006", nasc: "1995-12-05", sexo: "feminino", conv: null },
    { k: "gabriel", nome: "[TESTE] Gabriel Nunes", cpf: "10000000007", nasc: "1988-06-14", sexo: "masculino", conv: "sulamerica" },
    { k: "helena", nome: "[TESTE] Helena Castro", cpf: "10000000008", nasc: "2000-03-27", sexo: "feminino", conv: null },
    { k: "igor", nome: "[TESTE] Igor Ramalho", cpf: "10000000009", nasc: "1983-08-09", sexo: "masculino", conv: null },
    { k: "juliana", nome: "[TESTE] Juliana Freitas", cpf: "10000000010", nasc: "1997-01-21", sexo: "feminino", conv: "bradesco" },
    { k: "lucas", nome: "[TESTE] Lucas Andrade", cpf: "10000000011", nasc: "1991-05-16", sexo: "masculino", conv: null },
    { k: "mariana", nome: "[TESTE] Mariana Teixeira", cpf: "10000000012", nasc: "1986-10-02", sexo: "feminino", conv: "unimed" },
  ];
  const PA = {};
  for (const [i, p] of PACS.entries()) {
    PA[p.k] = await porChaveNatural(
      ...
      { cpf: p.cpf },
      {
        nome: p.nome, data_nascimento: p.nasc, sexo: p.sexo, ativo: true,
        ...
        contato_emergencia_nome: "[TESTE] Contato Emergência",
  ...
  const ITENS = [
    { k: "vitc", desc: "[TESTE] Ampola Vitamina C", cls: "material_consumo", un: "un", ent: 20, min: 5, custo: 18, lote: "LOTE-TESTE-001", val: 400 },
    { k: "hialuronico", desc: "[TESTE] Ácido Hialurônico 1ml", cls: "medicamento", un: "un", ent: 15, min: 3, custo: 320, lote: "LOTE-AH-2201", val: 300 },
    { k: "toxina", desc: "[TESTE] Toxina Botulínica 50UI", cls: "medicamento", un: "fr", ent: 10, min: 2, custo: 480, lote: "LOTE-TX-9910", val: 240 },
    { k: "argila", desc: "[TESTE] Máscara de Argila", cls: "material_consumo", un: "un", ent: 30, min: 8, custo: 12, lote: "LOTE-AR-0450", val: 500 },
    { k: "luvas", desc: "[TESTE] Luvas Descartáveis (cx 100)", cls: "descartavel", un: "cx", ent: 40, min: 10, custo: 35, lote: "LOTE-LV-7788", val: 900 },
    { k: "gaze", desc: "[TESTE] Gaze Estéril (pct)", cls: "descartavel", un: "pct", ent: 25, min: 5, custo: 8, lote: "LOTE-GZ-3321", val: 700 },
    { k: "glicolico", desc: "[TESTE] Ácido Glicólico 70%", cls: "material_consumo", un: "fr", ent: 6, min: 10, custo: 95, lote: "LOTE-GL-1102", val: 120 }, // ← saldo baixo
    { k: "serum", desc: "[TESTE] Sérum Reparador", cls: "produto_venda", un: "un", ent: 12, min: 4, custo: 60, lote: "LOTE-SR-6655", val: 365 },
  ];
  const IT = {};
  for (const it of ITENS) {
    IT[it.k] = await porChaveNatural(
      ...
      { clinica_id: CLINICA_ID, descricao: it.desc },
      {
        ...
        fornecedor: "[TESTE] Distribuidora Demo", ativo: true,
    ...
    const { error } = await db.from("movimentacao_estoque").upsert(
      {
        ...
        data: dia(-20), fornecedor: "[TESTE] Distribuidora Demo",
  ...
  console.log(`  ✓ ${ITENS.length} itens de estoque c/ entrada (lote+validade) — '[TESTE] Ácido Glicólico 70%' abaixo do mínimo (alerta)`);
  ...
  for (const [k, off, hora, pk, prk, sk, status, tipo] of AGENDA) {
    ...
    C[k] = await porId(
      ...
      k,
      {
        ...
        observacoes: `[TESTE] Agendamento de demonstração (${k}).`,
      },
      `consulta ${k}`
    );
  ...
  for (const pr of PRONT) {
    ...
    const { error: eIns } = await db.from("evolucao_insumo").upsert(
      {
        ...
        fabricante: "[TESTE] Fabricante Demo",
    ...
    await porId(
      ...
      `doc:${pr.k}`,
      {
        ...
        titulo: "[TESTE] Termo de Consentimento Livre e Esclarecido",
        conteudo:
  ...
  await porId(
    ...
    "doc:atestado:ana",
    {
      ...
      titulo: "[TESTE] Atestado de Comparecimento",
  ...
  const { data: form } = await db
    ...
    .eq("nome", "[TESTE] Anamnese Estética")
    .maybeSingle();
  if (form) {
  ...
  } else avisos.push("formulário '[TESTE] Anamnese Estética' não encontrado — anamneses puladas");
  ...
  for (const f of FOTOS) {
    ...
    await porId(
      ...
      `gf:${f.k}`,
      {
        ...
        descricao: `[TESTE] Registro ${f.cat} — placeholder de demonstração.`,
      },
      `galeria ${f.k}`
    );
  }
  ...
  const CONTAS = [
    { k: "caixa", nome: "[TESTE] Caixa da Recepção", tipo: "caixa", saldo: 500 },
    { k: "cc", nome: "[TESTE] Banco Demo — Conta Corrente", tipo: "conta_corrente", saldo: 10000, banco: "Banco Demo S/A", ag: "0001", num: "12345-6" },
  ];
  const CT = {};
  ...
  const CATS = [
    { k: "rec_serv", nome: "[TESTE] Vendas de Serviços", tipo: "receita" },
    { k: "rec_conv", nome: "[TESTE] Repasse de Convênios", tipo: "receita" },
    { k: "rec_prod", nome: "[TESTE] Venda de Produtos", tipo: "receita" },
    { k: "des_aluguel", nome: "[TESTE] Aluguel", tipo: "despesa" },
    { k: "des_insumos", nome: "[TESTE] Insumos e Materiais", tipo: "despesa" },
    { k: "des_comissao", nome: "[TESTE] Comissões", tipo: "despesa" },
    { k: "des_util", nome: "[TESTE] Utilidades", tipo: "despesa" },
    { k: "des_mkt", nome: "[TESTE] Marketing", tipo: "despesa" },
  ];
  const CA = {};
  ...
  const CCS = [
    { k: "facial", nome: "[TESTE] Estética Facial", cor: "#6366f1" },
    { k: "corporal", nome: "[TESTE] Estética Corporal", cor: "#10b981" },
    { k: "admin", nome: "[TESTE] Administrativo", cor: "#94a3b8" },
  ];
  const CC = {};
  for (const c of CCS)
  ...
  for (const o of ORCS) {
    ...
    O[o.k] = await porId(
      ...
      o.k,
      {
        ...
        anotacoes_internas: `[TESTE] Card de kanban (${o.status}).`,
      },
      `orçamento ${o.k}`
    );
  ...
  const DESP = [
    { k: "d01", desc: "[TESTE] Aluguel da unidade", valor: 3500, venc: -10, cat: "des_aluguel", cc: "admin", baixar: true, conta: "cc", forma: "transferencia" },
    { k: "d02", desc: "[TESTE] Energia elétrica", valor: 680.45, venc: -8, cat: "des_util", cc: "admin", baixar: true, conta: "cc", forma: "boleto" },
    { k: "d03", desc: "[TESTE] Compra de insumos — Distribuidora Demo", valor: 1250, venc: -12, cat: "des_insumos", cc: "facial", baixar: true, conta: "cc", forma: "pix" },
    { k: "d04", desc: "[TESTE] Campanha de mídia paga", valor: 900, venc: 5, cat: "des_mkt", cc: "admin", baixar: false, status: "pendente" },
    { k: "d05", desc: "[TESTE] Internet e telefonia", valor: 220, venc: 10, cat: "des_util", cc: "admin", baixar: false, status: "pendente" },
    { k: "d06", desc: "[TESTE] Material de limpeza", valor: 180.9, venc: -3, cat: "des_insumos", cc: "corporal", baixar: false, status: "atrasado" },
  ];
  for (const d of DESP) {
    const row = {
  ...
  await porId(
    ...
    "lanc:r01",
    {
      tipo: "receita", descricao: "[TESTE] Venda de produto — Sérum Reparador",
  ...
  // ── 15) Marketing ────────────────────────────────────────────────────────
  const CUPONS = [
    { k: "bemvindo", cod: "[TESTE]BEMVINDO10", tipo: "percentual", v: 10, status: "ativo", ini: -30, fim: 60, usos: 14, d: "10% na primeira sessão" },
    { k: "verao", cod: "[TESTE]VERAO50", tipo: "valor", v: 50, status: "ativo", ini: -10, fim: 45, usos: 6, d: "R$50 off em protocolos corporais" },
    { k: "black", cod: "[TESTE]BLACK20", tipo: "percentual", v: 20, status: "expirado", ini: -120, fim: -60, usos: 31, d: "Campanha encerrada (histórico)" },
  ];
  const CU = {};
  ...
  const LEADS = [
    { k: "l1", nome: "[TESTE] Patrícia Gomes", tel: "(11) 98111-0001", origem: "cupom", cupom: "bemvindo", status: "novo" },
    { k: "l2", nome: "[TESTE] Roberto Silva", tel: "(11) 98111-0002", origem: "marketplace", cupom: null, status: "novo" },
    { k: "l3", nome: "[TESTE] Camila Ferraz", tel: "(11) 98111-0003", origem: "cupom", cupom: "verao", status: "publicado" },
    { k: "l4", nome: "[TESTE] Thiago Moreira", tel: "(11) 98111-0004", origem: "lista_vip", cupom: null, status: "novo" },
    { k: "l5", nome: "[TESTE] Aline Barros", tel: "(11) 98111-0005", origem: "marketplace", cupom: null, status: "publicado" },
    { k: "l6", nome: "[TESTE] Marcelo Pinto", tel: "(11) 98111-0006", origem: "cupom", cupom: "bemvindo", status: "novo" },
  ];
  ...
  for (const d of DEPS)
    await porId(
      "depoimento", `dep:${d.k}`,
      {
        paciente_id: PA[d.pac], paciente_nome: PACS.find((p) => p.k === d.pac).nome.replace("[TESTE] ", "[TESTE] "),
  ...
  await porId(
    "campanha", "camp:1",
    {
      nome: "[TESTE] Reativação — Mulheres 25-45 (SP)", status: "ativa",
      ...
      conteudo: {
        ...
        corpo: "Use o cupom [TESTE]BEMVINDO10 e agende seu horário. (Mensagem fictícia.)",
      },
  ...
  const SALA = await porChaveNatural(
    "sala_vip",
    { clinica_id: CLINICA_ID, nome: "[TESTE] Sala VIP — Protocolo Premium" },
    {
  ...
  const MEMBROS = [
    { k: "m1", nome: "[TESTE] Vanessa Duarte", tel: "(11) 97222-0001", status: "aprovado" },
    { k: "m2", nome: "[TESTE] Rodrigo Alencar", tel: "(11) 97222-0002", status: "contatado" },
    { k: "m3", nome: "[TESTE] Beatriz Nogueira", tel: "(11) 97222-0003", status: "novo" },
  ];
